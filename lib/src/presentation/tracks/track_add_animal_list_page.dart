...
class TrackAddAnimalListPage extends StatelessWidget implements IFionaAppBarLayoutPage {

  String? title;
  late TrackAddState state;
  TrackAddAnimalListPage(BuildContext context, {Key? key}) : super(key: key) {
