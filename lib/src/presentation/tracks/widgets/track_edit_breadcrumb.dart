...
class TrackEditBreadcrumb extends StatelessWidget{

  FionaLogger logger = DependencyManager().get<FionaLogger>();

  List<TrackEditBreadcrumbItem>? breadcrumbs;

  TrackEditBreadcrumb({this.breadcrumbs});
  ...
  Widget build(BuildContext context) {
    ...
    return Row( children: [ Text(bread) ]);
  }
}


class TrackEditBreadcrumbItem{

  String text;
  void onTap;

  TrackEditBreadcrumbItem(this.text);
}
