...
class TrackAddAnimalEditPage extends StatelessWidget implements IFionaAppBarLayoutPage {

  late TrackAnimalCategoryTab categoryTab;

  TrackAddAnimalEditPage(BuildContext context, {Key? key}) : super(key: key) {
