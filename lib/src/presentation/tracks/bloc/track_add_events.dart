...
class TrackLivestockEditTrackFoodRequested extends TrackAddEvent {
  final TrackFood  _trackFood;

  const TrackLivestockEditTrackFoodRequested(this._trackFood);

  TrackFood getTrackFood() => _trackFood;
